...
Key domain vocabulary from this collection: sample, name, document, processing, aiprivatesearch, docid, file, tests, sampleclass, test, created, time, samplestruct, null, return, info, const, capabilities, data, greet, string, email, content, type, true.
