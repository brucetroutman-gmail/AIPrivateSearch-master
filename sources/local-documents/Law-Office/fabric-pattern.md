...
Key domain vocabulary from this collection: email, clientid, office, attorney, michael, firstname, lastname, phone, city, springfield, state, laura, bennett, sarah, coleman, david, paralegal, reynolds, patel, appointmentid, date, time, purpose, location, address.
